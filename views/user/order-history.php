...
<div class="container py-4 py-md-5 order-page order-history-page" style="min-height: 70vh;">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3 h-100 stats-card" style="border-radius: 12px; background: var(--yumgo-surface-card);">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h6 class="text-secondary small mb-1">Tổng chi tiêu (Đã nhận)</h6>
    ...
    <div class="status-tabs">
        ...
        <a href="<?= buildHistoryUrl(array_merge($queryParams, ['status' => 'completed']), 1) ?>" class="status-tab <?= $status === 'completed' ? 'active' : '' ?>">Đã nhận</a>
                        ...
                        <?php foreach ($orders as $o): ?>
                            <tr class="table-row-hover">
                                ...
                                <td>
                                    ...
                                    <?php if (strpos($o['status'], 'Cancelled') !== false && !empty($o['cancel_reason'])): ?>
                                        <div class="small text-danger mt-1">Lý do: <?= htmlspecialchars($o['cancel_reason']) ?></div>
                                    <?php endif; ?>
                                </td>
        ...
        <div class="order-history-cards d-md-none">
            <?php foreach ($orders as $o): ?>
                ...
                <div class="order-mobile-card">
                    ...
                    <?php if (strpos($o['status'], 'Cancelled') !== false && !empty($o['cancel_reason'])): ?>
                        <div class="text-danger small px-3 pt-2"><strong>Lý do hủy:</strong> <?= htmlspecialchars($o['cancel_reason']) ?></div>
                    <?php endif; ?>
