...
<head>
    ...
    <link href="assets/css/user.css?v=20260613-final1" rel="stylesheet">
...
>
    ...
    <div class="drawer-overlay" x-cloak x-show="showCart" :class="showCart ? 'show' : ''" @click="showCart = false"></div>
            ...
            <div x-show="<?php echo !empty($drawerCartItems) ? 'true' : 'false'; ?>" class="d-flex flex-column gap-3" id="drawerCartList">
                <?php foreach ($drawerCartItems as $item): ?>
                    <div class="d-flex align-items-center gap-3 py-2 border-bottom" data-food-id="<?php echo (int)$item['food_id']; ?>">
                        ...
                        <a href="index.php?page=cart-remove&id=<?php echo (int)$item['food_id']; ?>&csrf_token=<?php echo urlencode(csrfToken()); ?>" class="p-2" title="Xóa món" style="color: #ff4d4d !important;">
    ...
    <div class="menu-overlay" x-cloak x-show="showMenu" :class="showMenu ? 'show' : ''" @click="showMenu = false"></div>
