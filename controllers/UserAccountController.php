...
class UserAccountController
{
    ...
    public function updateProfile(): void
    {
        ...
        if (!verifyCsrfToken($_POST['csrf_token'] ?? null)) {
            $_SESSION['account_profile_errors'] = ['Phiên làm việc không hợp lệ. Vui lòng tải lại trang và thử lại.'];
            redirect(BASE_URL . '/index.php?page=account');
        }
    ...
    public function updatePassword(): void
    {
        ...
        if (!verifyCsrfToken($_POST['csrf_token'] ?? null)) {
            $_SESSION['account_password_errors'] = ['Phiên làm việc không hợp lệ. Vui lòng tải lại trang và thử lại.'];
            redirect(BASE_URL . '/index.php?page=account');
        }
